...
function ObtenerCarta(){
  ...
  function altaCarta($body)
  {
    ...
    if(validarString($result->nombre,"nombre",2,50) && validarString($result->url,"url",5,500) && validarNum($result->precio,"precio") && validarSelect($result->categoria,"categoria"))
    {
