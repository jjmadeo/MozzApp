...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-11-2020 a las 18:54:08
...
(11, 'JUANJO gonzalez', 'MADEO', 'TT', 'josecg90', '$2y$10$goFAXywwVbZGt/QQxRko5.oR.udRlXP/PiwtrDn/mFO5CemoJvc5.', 2, '0000-00-00 00:00:00'),
...
(10009, 'Cajeross', 'Cajero Prueba', 'TT', 'cajero', '$2y$10$kePsUtrUItkEIP/vbODSBemcRcKVkGr5tM6Hrd/e6c34I7QaI5Gkm', 3, '0000-00-00 00:00:00'),
(10010, 'nicolas', 'garrido', 'TT', 'ggarrido', '$2y$10$njDOdbjtOPebSQGe4UCyU.x3E6vBViofD1/qa0MO3ioTkfEYg5PAe', 1, '2020-11-24 22:50:57');
...
(2, 10007, 1, '2020-11-24 22:36:18'),
(3, 11, 2, '2020-11-14 02:11:48'),
(4, 1, 3, '2020-11-24 22:47:05'),
(5, 4, 4, '2020-11-24 18:09:33'),
(6, 1, 5, '2020-11-24 22:47:07'),
...
--
ALTER TABLE `empleado`
  MODIFY `EMPLID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10011;
...
--
ALTER TABLE `notificacion`
  MODIFY `NOTIFICACIONID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;

--
-- AUTO_INCREMENT de la tabla `pedido`
--
ALTER TABLE `pedido`
  MODIFY `PEDIDOID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `relacartapedido`
  MODIFY `RELA_C_P_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
